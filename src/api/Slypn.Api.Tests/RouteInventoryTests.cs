...
public class RouteInventoryTests
{
    ...
    [
        "DELETE /articles/{id}                            DeleteArticle              Admin                        Slypn.Api.Functions.ArticlesFunctions.Delete",
        "GET    /articles                                 GetArticles                optional-auth                Slypn.Api.Functions.ArticlesFunctions.GetArticles",
        "POST   /articles                                 CreateArticle              Admin+Contributor            Slypn.Api.Functions.ArticlesFunctions.Create",
        "GET    /articles/{slug}                          GetArticleBySlug           optional-auth                Slypn.Api.Functions.ArticlesFunctions.GetArticleBySlug",
        "PUT    /articles/{id}                            ReplaceArticle             Admin+Contributor            Slypn.Api.Functions.ArticlesFunctions.Replace",
        "POST   /articles/{id}/cancel-deletion            CancelArticleDeletion      Admin                        Slypn.Api.Functions.ArticlesFunctions.CancelDeletion",
        "POST   /articles/{id}/edit                       EditPublishedArticle       Admin+Contributor            Slypn.Api.Functions.ArticlesFunctions.Edit",
        "POST   /articles/{id}/publish                    PublishArticle             Admin                        Slypn.Api.Functions.ArticlesFunctions.Publish",
        "POST   /articles/{id}/request-deletion           RequestArticleDeletion     Admin+Contributor            Slypn.Api.Functions.ArticlesFunctions.RequestDeletion",
        "POST   /articles/{id}/revise                     ReviseArticle              Admin                        Slypn.Api.Functions.ArticlesFunctions.Revise",
        "POST   /articles/{id}/withdraw                   WithdrawArticle            Admin+Contributor            Slypn.Api.Functions.ArticlesFunctions.Withdraw",
